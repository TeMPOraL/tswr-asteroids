    ...
    (with-slots (sprite color scale) (p2de:find-component entity 'renderable)
      ...
      (gl:with-pushed-matrix
        ...
        (gl:with-pushed-matrix
          ...
          (draw-pseudo-sprite sprite scale color dt))
...
(defun make-powerup-sprite (letter)
  (lambda (scale color dt)
    (declare (ignore dt))
    (p2dglu:color4 color)

    (draw-text (string letter)
               :size scale
               :alignment-x :center
               :alignment-y :center)
